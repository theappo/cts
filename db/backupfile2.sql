...
--
-- Table structure for table `TeamBids`
--

DROP TABLE IF EXISTS `TeamBids`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `TeamBids` (
  `proj_id` varchar(64) NOT NULL,
  `team_id` varchar(64) NOT NULL,
  `dev1joined` tinyint(1) DEFAULT NULL,
  `dev2joined` tinyint(1) DEFAULT NULL,
  `dev3joined` tinyint(1) DEFAULT NULL,
  `dev4joined` tinyint(1) DEFAULT NULL,
  `dev5joined` tinyint(1) DEFAULT NULL,
...
--
-- Dumping data for table `TeamBids`
--

LOCK TABLES `TeamBids` WRITE;
/*!40000 ALTER TABLE `TeamBids` DISABLE KEYS */;
/*!40000 ALTER TABLE `TeamBids` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `currentprojects` (
  ...
  `team_chosen` varchar(64) DEFAULT NULL,
...
CREATE TABLE `interests` (
  `user_id` varchar(64) DEFAULT NULL,
  `interest_name` varchar(64) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `projecthistory` (
  ...
  `client_review` varchar(512) DEFAULT NULL,
  `team_id` varchar(64) DEFAULT NULL,
  `description` varchar(512) DEFAULT NULL,
  `language` varchar(32) DEFAULT NULL,
  `submittedproject` varchar(512) DEFAULT NULL,
  PRIMARY KEY (`proj_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `projectreviews` (
  ...
  PRIMARY KEY (`proj_id`,`dev_id`,`receiver_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-11-15 12:32:53
